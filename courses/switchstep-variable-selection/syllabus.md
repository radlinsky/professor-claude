...
**Source:** concept — the method described in
[docs/fable-switchstep-prompt.md](../../docs/fable-switchstep-prompt.md) (a frequentist,
likelihood-based variable-selection procedure), built up from ISLR ch. 3 & 6 and VMLS
